...
func checkfun_alias_IsEqualExact(s TestSample) (bool, string) {
	...
	expected := !singular
	clone := s.Points[0].Clone()
	return guardForInvalidPoints(expected, singular, "Querying P == P exactly failed for identical arguments", clone.IsEqual_exact, clone)
}
...
func checkfun_alias_Double(s TestSample) (bool, string) {
	...
	singular := s.AnyFlags().CheckFlag(Case_singular)
	expected := !singular
	var clone1 CurvePoint = s.Points[0].Clone().(CurvePoint)
	clone2 := s.Points[0].Clone()
	result := MakeCurvePointFromType(GetPointType(s.Points[0]))
	result.Double(clone2)
	clone1.Double(clone1)
	return guardForInvalidPoints(expected, singular, "Computing Double failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_Neg(s TestSample) (bool, string) {
	...
	result.Neg(clone2)
	clone1.Neg(clone1)
	return guardForInvalidPoints(expected, singular, "Computing negative failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_Endo(s TestSample) (bool, string) {
	...
	return guardForInvalidPoints(expected, singular, "Computing endomorphism failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_EndoFullCurve(s TestSample) (bool, string) {
	...
	return guardForInvalidPoints(expected, singular, "Computing endomorphism (full version) failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_AddEq(s TestSample) (bool, string) {
	...
	var clone1 CurvePoint = s.Points[0].Clone().(CurvePoint)
	clone2 := s.Points[0].Clone()
	result := s.Points[0].Clone().(CurvePoint)
	result.AddEq(clone2)
	clone1.AddEq(clone1)
	return guardForInvalidPoints(expected, singular, "Computing AddEq failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_SubEq(s TestSample) (bool, string) {
	...
	result.SubEq(clone2)
	clone1.SubEq(clone1)
	return guardForInvalidPoints(expected, singular, "Computing SubEq failed when receiver aliases argument", clone1.IsEqual_exact, result)
}
...
func checkfun_alias_SetFrom(s TestSample) (bool, string) {
	...
	return guardForInvalidPoints(expected, singular, "SetFrom failed when receiver aliases argument", clone1.IsEqual_exact, result)
}

func test_aliasing_CurvePoint(t *testing.T, receiverType PointType, excludedFlags PointFlags) {
	...
	make_samples1_and_run_tests(t, checkfun_alias_IsEqualExact, "Alias testing for IsEqual_exact failed "+point_string, receiverType, 10, excludedFlags)
...
func TestAliasingForXTW(t *testing.T) {
	test_aliasing_CurvePoint(t, pointTypeXTW, 0)
}

func TestAliasingForAXTW(t *testing.T) {
	test_aliasing_CurvePoint(t, pointTypeAXTW, 0)
}

func TestAliasingForEFGH(t *testing.T) {
	test_aliasing_CurvePoint(t, pointTypeEFGH, 0)
}
